        ...
        <div class="col-12 col-md-8 order-md-1 text-center text-md-end">
			...
			<form method="post" action="">
				<div class="input-group mb-3 flex-row-reverse">
					<button class="btn btn-color-omega text-light d-flex align-items-center" type="button" aria-label="search"><i class="icon-search"></i></button>
					<input type="text" class="form-control" placeholder="نام هتل یا شهر مورد نظر..." aria-label="search" aria-describedby="search city or hotel name">
				</div>
			</form>
